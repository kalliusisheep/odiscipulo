...
export const BIBLICAL_CHARACTERS: BiblicalCharacter[] = [
  {
    ...
    hints: ["Sua infância foi preservada em um cesto colocado entre os juncos.", "Deus o chamou por meio de uma sarça que ardia sem ser consumida.", "Ele conduziu o povo pelo mar e recebeu as tábuas da aliança."],
  },
  {
    ...
    hints: ["Era o filho mais novo de Jessé e cuidava das ovelhas.", "Enfrentou um guerreiro muito maior usando uma funda.", "Tornou-se rei e estabeleceu Jerusalém como centro do reino."],
  },
  {
    ...
    hints: ["Depois de ficar viúva, decidiu acompanhar sua sogra para uma terra estrangeira.", "Recolhia espigas nos campos para sustentar as duas.", "Casou-se com Boaz e tornou-se antepassada do rei Davi."],
  },
  {
    ...
    hints: ["Trabalhava como pescador quando recebeu o chamado para seguir Jesus.", "Caminhou sobre as águas, mas começou a afundar quando teve medo.", "Pregou no Pentecostes e anunciou a boa notícia a uma grande multidão."],
  },
  {
    ...
    hints: ["Antes de seguir Jesus, combatia duramente os primeiros discípulos.", "Uma luz intensa o fez cair no caminho para uma cidade importante.", "Escreveu cartas para várias igrejas e realizou viagens missionárias."],
  },
  {
    ...
    hints: ["Foi criada por seu primo depois de perder os pais.", "Chegou ao palácio e se tornou rainha em um império estrangeiro.", "Entrou sem ser chamada na presença do rei para interceder por seu povo."],
  },
  {
    ...
    hints: ["Aconselhava o povo debaixo de uma palmeira.", "Chamou Baraque para reunir as tribos contra um exército opressor.", "Sua vitória foi celebrada em um cântico junto com Baraque."],
  },
  {
    ...
    hints: ["Recebeu seu chamado enquanto malhava trigo escondido por causa dos inimigos.", "Pediu sinais envolvendo um velo para discernir a direção de Deus.", "Seu exército foi reduzido a apenas trezentos homens antes da batalha."],
  },
  {
    ...
    hints: ["Seu nome dado pelos apóstolos está relacionado a encorajamento.", "Vendeu um campo e colocou o valor aos pés dos apóstolos.", "Apoiou a entrada de Saulo no círculo dos discípulos e depois viajou com ele."],
  },
  {
    ...
    hints: ["Trabalhava com tecidos de cor púrpura em uma cidade da Macedônia.", "Ouviu a mensagem junto a um lugar de oração perto de um rio.", "Depois de ser batizada, insistiu para que os missionários ficassem em sua casa."],
  },
  {
    ...
    hints: ["Surgiu no relato após uma batalha vencida por Abraão.", "Trouxe pão e vinho e pronunciou uma bênção sobre o patriarca.", "Seu nome é usado em Hebreus para explicar um sacerdócio diferente do levítico."],
  },
  {
    ...
    hints: ["Era da tribo de Judá e descendia de uma família ligada à liderança.", "Recebeu habilidade especial para trabalhar com ouro, prata, bronze e madeira.", "Coordenou a produção dos objetos e tecidos do santuário móvel."],
  },
];
