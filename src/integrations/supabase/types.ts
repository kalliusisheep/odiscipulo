  ...
  public: {
    Tables: {
      ...
      discipleship_content_trails: {
        ...
        Relationships: [
          {
            foreignKeyName: "discipleship_content_trails_module_id_fkey"
            columns: ["module_id"]
            isOneToOne: false
            referencedRelation: "discipleship_content_modules"
            referencedColumns: ["id"]
          },
        ]
      }
