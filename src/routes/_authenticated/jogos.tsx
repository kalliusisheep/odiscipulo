  ...
  return (
    <main className="game-arena-page min-h-screen bg-background">
      <div className="mx-auto max-w-lg px-4 pb-28 pt-5">
        ...
        <Link to="/jogos/ranking" className="mt-5 flex items-center justify-between rounded-2xl border border-ancient/25 bg-ancient/10 px-4 py-3 text-sm font-extrabold text-ancient"><span className="flex items-center gap-2"><Trophy className="h-4 w-4" /> Ranking global dos jogos</span><ArrowRight className="h-4 w-4" /></Link>
