...
export const Route = createFileRoute("/_authenticated/jogos/versiculo")({
  validateSearch: (search: Record<string, unknown>) => ({
    ...
    rounds: normalizeRounds(search.rounds, 10),
  }),
...
function VersiculoPage() {
  ...
  if (phase === "setup" && !modeSelected) return <GameModeChooser title="Qual é o versículo?" description="Escolha entre reconhecer a passagem no seu ritmo ou disputar uma sala sincronizada com seus amigos." onBack={() => { window.location.href = "/jogos"; }} onSinglePlayer={() => setModeSelected(true)} onMultiplayer={() => { window.location.href = "/jogos/multiplayer?game=versiculo"; }} />;
  ...
  return <main className="game-play-page min-h-screen bg-background"><div className="mx-auto max-w-lg px-4 pb-28 pt-5">
